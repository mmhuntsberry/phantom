  ...
  return (
    <div className={styles.container}>
      <section className={styles.hero}>
        <h1 className={styles.title}>ARC Readers</h1>
        <p className={styles.subtitle}>
          ARC readers get full drafts before release and share feedback and
      ...
      <section className={styles.formSection}>
        <h2 className={styles.sectionTitle}>Join the ARC list</h2>
